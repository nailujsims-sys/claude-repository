...
| Header / top bar of a main area | `src/components/TopBar.jsx` — one bar for every screen: fixed height, fixed insets, hamburger, title (+ optional subtitle) and a right-anchored action rail. Never build a screen header by hand |
